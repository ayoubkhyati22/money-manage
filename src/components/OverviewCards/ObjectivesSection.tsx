...
export function ObjectivesSection({
  ...
  return (
    <div className="bg-white/90 dark:bg-dark-800/90 backdrop-blur-sm rounded-2xl shadow-lg border border-mint-200/50 dark:border-dark-600/50 overflow-hidden">
      <div className="bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/30 dark:to-primary-800/30 p-4 sm:p-6 border-b border-primary-200 dark:border-dark-600">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold text-dark-500 dark:text-dark-100">Objectives Overview</h3>
            <p className="text-xs sm:text-sm text-dark-400 dark:text-dark-300 mt-1">Your financial goals</p>
          </div>
          {totalCount > 0 && (
